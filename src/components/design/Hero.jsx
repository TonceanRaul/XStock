...
const Rings = () => {
    return (
        <>
            <div className="absolute w-[65.875rem] aspect-square border border-n-2/10 rounded-full -translate-x-1/2 -translate-y-1/2 transform -rotate-90" />
            <div className="absolute right-0 w-[65.875rem] aspect-square border border-n-2/10 rounded-full translate-x-1/2 -translate-y-1/2 transform -rotate-90" />
        </>
    );
};
